<?php
$pattern['OS_default_prefilter_index']['S']['table_content_begin']='<div id="content" class="content">';
$pattern['OS_default_prefilter_index']['R']['table_content_begin']='<div id="content" class="content">
...
';
$pattern['OS_default_prefilter_picture']['S']['div_imageInfos_deletion']='#<div id="imageInfos">.*<table id="standard" class="infoTable">#s';
$pattern['OS_default_prefilter_picture']['R']['div_imageInfos_deletion']='<table id="standard" class="infoTable">';
?>